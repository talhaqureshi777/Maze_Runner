...
public class Spawn_room_1 : MonoBehaviour
{

    [SerializeField] GameObject prefeb_room_1_Object;
    ...
    void object_spawn()
    {
        for (int i = 0; i < 10; i++)
        {
            ...
            Instantiate(prefeb_room_1_Object, random_position, Quaternion.identity);
        }
    }
