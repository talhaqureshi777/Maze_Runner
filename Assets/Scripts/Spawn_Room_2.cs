...
public class Spawn_Room_2 : MonoBehaviour
{
    [SerializeField] GameObject prefeb_room_2_Object;
    ...
    void object_spawn()
    {
        for (int i = 0; i < 10; i++)
        {
            ...
            Instantiate(prefeb_room_2_Object, random_position, Quaternion.identity);
        }
    }
